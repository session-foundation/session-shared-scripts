...
Stdlib unittest so the repo needs no test dependency. Run from anywhere:
    ...
    uv run python -m unittest tests.crowdin.test_language_list
...
from session_ops.crowdin.generate_shared import cldr_locale, is_rtl
from session_ops.crowdin.generate_language_list import (
    build_language_data,
    display_name,
    locale_keys,
    territory_for,
