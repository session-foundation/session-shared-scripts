...
It is also the way to mute one account in a room (`--write off`) without banning it.
    ...
    sogs-perms --room session-updates --write on --upload on 05<test account>
    sogs-perms --room session-updates --write default --upload default 05<id>
...
from session_ops.sogs.ban import (
    SESSION_ID_RE,
    SOGS_PUBKEY,
    SOGS_URL,
    Sogs,
